 ...
 * @author Alonso
 */
public class SeleccionarDireccion extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       if(!CargarInfo().isEmpty())
       {
            ...
            AñadirCliente.claveDoc=Controller.DomiciliosController.BusquedaClave(Integer.parseInt(direccion));
            AñadirCliente.domiciliojTextArea.setText(CargarInfo());
            dispose();
       }
       else
       {
    ...
    private void seleccionarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seleccionarjButtonActionPerformed
       if(!CargarInfo().isEmpty())
       {
            ...
            EditarCliente.claveEdit=domicilio;
            EditarCliente.direccionjTextArea.setText(CargarInfo());
            dispose();
       }
       else
       {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarDireccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionarDireccion().setVisible(true);
            }
        });
    }
