...
public class AñadirProveedor extends javax.swing.JFrame {
        ...
        boolean ValidarProveedor()
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Tienes que ingresar al menos 12 caracteres para el RFC"
                    ,"Sistema Central", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        ...
        {
            JOptionPane.showMessageDialog(null, "No sobrepasar los 12 caracteres para el telefono"
                    ,"Sistema Central", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        else if(telefonojTextField.getText().length()<12)
        {
            JOptionPane.showMessageDialog(null, "Tienes que ingresar al menos 12 caracteres para el telefono"
                    ,"Sistema Central", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        else if(razonSocialjTextField.getText().equalsIgnoreCase(""))
        {
            JOptionPane.showMessageDialog(null, "No puede dejar vacio la razon social"
                    ,"Sistema Central", JOptionPane.ERROR_MESSAGE);
            return false;
        }
    ...
    private void initComponents() {
        ...
        proveedorjTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Empresa", "RFC", "Telefono", "Razon Social", "Status"
            }
        ) {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(rfcjTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        empresa.jButton1.setVisible(true);
        empresa.seleccionarjButton.setVisible(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(ValidarProveedor()==true)
        {
            ...
            Direcciones dir= Controller.DireccionController.BuscarDireccion(1);
            Empresasproveedoras empresa = Controller.EmpresaProveedoraController.busquedaEmpresa(empresajTextField.getText());
            if(empresa==null)
            {
                
                    if(Controller.EmpresaProveedoraController.
                            CreateEmpresa(rfcjTextField.getText(),empresajTextField.getText(),
                            razonSocialjTextField.getText()
                            , hoy.getTime(), true, telefonojTextField.getText()
                            ,claveDir)==true)
                    {
            ...
            {
                JOptionPane.showMessageDialog(null, "Error ya existe una empresa con ese nombre");
            }
