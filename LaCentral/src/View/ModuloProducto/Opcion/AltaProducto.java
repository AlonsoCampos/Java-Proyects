...
void Mostrar()
    ...
    private void initComponents() {
        ...
        preciojTextField.setEnabled(false);

        cantidadjLabel1.setText("en:");

        jToggleButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ima/user_add_48.png"))); // NOI18N
        jToggleButton3.setText("Dar de Alta");
    ...
    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
        ...
        if(selected>=0)
        {
            ...
            if(Controller.DetallesProductosController.AltaDetalleProducto(producto.getClaveProducto())==true)
            {
