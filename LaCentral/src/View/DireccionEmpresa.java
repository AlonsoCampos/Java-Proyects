 ...
 * @author Alonso
 */
public class DireccionEmpresa extends javax.swing.JFrame {
    ...
    public  void loadMunicipios()
    {
        ...
        List<Estados> resultado=Controller.EstadosController.ShowEstados();
        ...
        */  
        for(Estados o: resultado){
           DisplayItem d = new DisplayItem(o.getEstado(), o.getClaveEstado());
            datos.addElement(d);
    ...
    void Registro()
    {
            ...
            Direcciones mostrar = Controller.DireccionController.BuscarDireccion(Integer.parseInt(clave));
            callejTextField.setText(mostrar.getCalle());
            ...
            municipiosjComboBox.setSelectedItem(mostrar.getEstados().getEstado());
    }
    ...
    void Agregar(){
        ...
        {
            Estados estado = Controller.EstadosController.
                    estado(municipiosjComboBox.getSelectedItem().toString());
            if(Controller.DireccionController.CreateDireccion(callejTextField.getText()
    ...
    void Modificar(int id){
        if(validarDirecciones()==true)
        {
            Estados estado = Controller.EstadosController.
                    estado(municipiosjComboBox.getSelectedItem().toString());
            if(Controller.DireccionController.UpdateDirecciones(id,callejTextField.getText()
                    ,numeroInternojTextField.getText(),
                    numeroExternojTextField.getText()
                    ,estado)==true)
            {
...
if((car<'a' || car>'z') && (car<'A' || car>'Z')) evt.consume();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DireccionEmpresa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
